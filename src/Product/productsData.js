...
`},
  {
    id: 30,
    name: " AlgoTRONN Strategy Creation Service",
    price:1,
...
CHARGES  DEPEND UPON REQUIREMENTS

 

-Simple/Complex strategy creation in Tradetron.
-Placing Set Level or Trade Level Trailing Stop Loss or MTM SL
-TradingView/Excel integration with Tradetron
-Any other requirements that cannot be achieved with keywords
-Custom requirements that require python code integration
 

Terms:
>Simple Strategies will be created and delivered within 3 Working Days.
>Complex Strategies would need more time and would be delivered by 10 Working Days.
>Complete Charges and approximate delivery timeline would be shared after reviewing the strategy requirement details.
>During Testing, shared code would be given by which one can monitor the Trades.
>Once Testing completed, Strategies would be delivered via private links to your Tradetron account. During the creation of the strategy, if we come across any unforeseen situations which can conclusively infer that the strategy could not be pursued as per the draft, a complete refund of the amount paid would be provided.
>After Delivery, in case there is issue with the code, or if something is not working as per initial requirement given,  there will be support provided to fix the issue. Slippage can't be controlled with the code and depends upon market volatality. 
